                            ...
                            {indices.map(i => (
                                <div className="media p-3">
                                    ...
                                    <div className="media-body">
                                        ...
                                        <p class="content contentQa">{contents[i]} {i == names.length - 1 && <input className="replyBtn" type="image" src={require("../../lib/qa/reply.png")} onClick={() => this.showReply(i, mediaId)} />} {names[i] === 'user1' && <a href="#" onClick={(e) => this.props.handleRemove(i, e)}>delete</a>} <button onClick={(e) => this.like(1, likes[i], e)} className="likeQa btn-primary">Like</button></p>

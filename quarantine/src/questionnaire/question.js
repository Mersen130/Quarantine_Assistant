            ...
            <div>
                ...
                <div>
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input onChange={this.props.handleCheck} type="radio" id="customRadioInline1" name="customRadioInline1" class="custom-control-input" />
                        <label class="custom-control-label" for="customRadioInline1">Y</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input onChange={this.props.handleCheck} type="radio" id="customRadioInline2" name="customRadioInline1" class="custom-control-input" />
                ...
                <div>
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input onChange={this.props.handleCheck} type="radio" id="customRadioInline3" name="customRadioInline1" class="custom-control-input" />
                        <label class="custom-control-label" for="customRadioInline3">2</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input onChange={this.props.handleCheck} type="radio" id="customRadioInline4" name="customRadioInline1" class="custom-control-input" />
                        <label class="custom-control-label" for="customRadioInline4">3</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input onChange={this.props.handleCheck} type="radio" id="customRadioInline5" name="customRadioInline1" class="custom-control-input" />
                ...
                <div>
                    ...
                    <div>
                        <button className="btn btn-secondary btnQuest" onClick={this.props.handleLast}>last question</button>
                        <button className="btn btn-secondary btnQuest" onClick={this.props.handleNext}>submit</button>
                    </div>
                </div>}
